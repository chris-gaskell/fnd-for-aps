  ...
  revealjs:
    include-in-header: 
      text: |
        ...
        <meta name="twitter:url" content="https://fnd-for-combined.netlify.app"/>
        <meta name="twitter:image" content="https://github.com/chris-gaskell/fnd-for-combined/blob/master/twitter-pic.jpg?raw=true"/>
        <meta name="twitter:image:alt" content="Title slide of An Introduction to Working with Functional Neurological Disorders presented to Medics and Psychologists for North Staffs Combined NHS Trust 2022."/>
    ...
    title: "Functional Neurological<br> Disorders"
    subtitle: "Teaching for Assistant Psychologists"
    preview-links: false
