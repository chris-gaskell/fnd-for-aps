  ...
  revealjs:
    include-in-header: 
      text: |
        ...
        <meta name="twitter:title" content="An Introduction to Working with Functional Neurological Disorders"/>
        <meta name="twitter:description" content="An Introduction to Working with Functional Neurological Disorders"/>
        <meta name="twitter:url" content="https://fnd-for-aps.netlify.app"/>
        <meta name="twitter:image" content="https://github.com/chris-gaskell/fnd-for-combined/blob/master/twitter-pic.jpg?raw=true"/>
        <meta name="twitter:image:alt" content="Title slide of An Introduction to Working with Functional Neurological Disorders presented to Midlands Assistant Psycholgoists Group Meeting, 2023."/>
    ...
    footer: "FND for Midlands Aspriring Psychologists"
    transition: slide
...
**Midlands Aspiring Psychologists Group**
...
![](https://pbs.twimg.com/profile_images/1434417640920002563/ZS62zhXl_400x400.jpg){style="border-radius: 50%; box-shadow: 0 0 30px black;" fig-align="center" width="240"}
...
[^1]: Not related to the behavioural notion of 'functional analysis'

[^2]: See excellent video by [John Stone](https://www.youtube.com/watch?v=ersm5f_0LVI&t=21s%22) for more on this.
...
::: columns
::: {.column width="50%"}
-   Neuroimaging in FND is an emerging area[^3].

-   Neurological differences shown in FND[^4].
...
[^3]: Figure taken from from Drane et al (2020)

[^4]: See [Perez et al (2021)](https://www.sciencedirect.com/science/article/pii/S221315822100067X) for a review
...
-   Based on positive clinical signs/symptoms[^5].
...
[^5]: Helpful articles on positive symptoms include [Aybeck, 2022](%22https://drive.google.com/file/d/1YZF-9aHuYeLkgAErzHXx4F-I-rC_2lNq/view) & [Finkelstein et al (2021)](https://onlinelibrary.wiley.com/doi/full/10.1111/acem.14263)
...
## Tips for Explaining the Diagnosis {background-color="white"}
...
::: columns
::: {.column width="50%"}
Much debate regarding preferred term[^6].
...
## Professional Beliefs {background-color="white"}
...
## Trauma & FND Onset {background-color="white"}
...
[^7]: See [Beal et al (2022](https://pubmed.ncbi.nlm.nih.gov/35339813/)) for a review of the area.
...
-   7+ outcome measures used per study (unpublished study).[^8]

-   Core outcome battery and specific tools still lacking (for now).

[^8]: Results being prepared for publication.
...
## Change Across Other Measures {background-color="white"}
...
## Tips for Acute Management {background-color="white"}
