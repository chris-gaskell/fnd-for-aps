...
-   Can a person be non-organic?[^3][^4]
...
[^4]: Also an excellent review on the use of the term [functional]{.underline} in medicine [(Smith, 2023)](https://doi.org/10.1136/bmj.p221)
...
::: columns
::: {.column width="50%"}
-   Neuroimaging in FND is an emerging area[^5].

-   Neurological differences shown in FND[^6].
...
[^5]: Figure taken from from Drane et al (2020)

[^6]: See [Perez et al (2021)](https://www.sciencedirect.com/science/article/pii/S221315822100067X) for a review
...
::: columns
::: {.column width="50%"}
Much debate regarding preferred term[^8].
...
FND is not Malingering! (see [Edwards et al., 2023](https://www.nature.com/articles/s41582-022-00765-z))
...
-   Does not explain presentation or timing of onset.
...
## Predictive Processing Errors {background-color="white"} {visibility="hidden"}
...
[^9]: See [Beal et al (2022](https://pubmed.ncbi.nlm.nih.gov/35339813/)) for a review of the area.
...
-   7+ outcome measures used per study (unpublished study).[^10]

-   Core outcome battery and specific tools still lacking (for now).

[^10]: Results being prepared for publication.
...
-   Medical gaslighting ([blog](https://cptsdfoundation.org/2020/06/08/medical-and-mental-health-gaslighting-and-iatrogenic-injury/) from PTSD Foundation.
